...
// Final on-demand version. No 'autoLoad' prop.
  ...
  return (
    <div className="p-4 bg-card/80 border rounded-lg flex flex-col min-h-[420px]">
      <div className="flex-grow">
        ...
        <div className="bg-muted/40 p-2 my-2 rounded max-h-32 overflow-y-auto"><pre className="text-sm whitespace-pre-wrap">{script}</pre></div>
      </div>
