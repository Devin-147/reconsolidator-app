      ...
      <div className="mt-4 pt-4 border-t border-primary/20 min-h-[250px] flex flex-col items-center justify-center">
        ...
        {isLoadingAi && (
          <div className="text-center">
            <div style={{width:120,height:120}} className="opacity-70 mx-auto"><MyActualLogo/></div>
            <p className="text-sm animate-pulse mt-2"><Loader2 className="inline mr-1 animate-spin"/>Crafting narration...</p>
          </div>
        )}
        ...
        {aiAudioError && !isLoadingAi && (
          <div className="text-red-500 text-sm text-center">
            <p>{aiAudioError}</p>
            <Button onClick={generateOrSimulateAiNarration} variant="link" size="sm">Try again</Button>
          </div>
        )}
