...
export const PhaseThree: React.FC<PhaseThreeProps> = ({ isCurrentPhase, response, onResponseChange, onComplete }) => {
    ...
    return (
        <div className="p-6 border rounded-lg bg-card shadow-lg space-y-4">
            <h3 className="text-xl font-semibold text-primary">Phase 3: View from the Projection Booth</h3>
            <p className="text-sm text-muted-foreground">Imagine yourself in the projection booth. From there, you can see yourself down in the seat, watching the black and white movie. Describe this double-dissociated perspective.</p>
