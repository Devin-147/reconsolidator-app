      ...
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="space-y-4 mb-8">
          <PlanOption
            ...
            price="47.00"
            description="Includes all 5 core treatments with AI-powered audio narrations."
          ...
          <PlanOption
            ...
            price="77.00"
            description="The complete program, PLUS personalized cinematic videos and advanced AI features."
        ...
        <Button onClick={() => navigate(-1)} variant="link" className="w-full mt-2 text-muted-foreground">
            Maybe Later
        </Button>
      </div>
    </div>
