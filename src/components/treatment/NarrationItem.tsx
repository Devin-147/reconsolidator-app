...
// Correctly implements auto-load/teaser logic based on shouldAttemptAiLoad prop from parent.
...
export const NarrationItem = ({
  ...
  return (
    <div className="p-4 bg-card/80 border rounded-lg flex flex-col justify-between min-h-[420px]">
      ...
      <div className="mt-auto"><h4 className="text-sm font-medium mt-4">Record Your Narration:</h4><NarrationRecorder index={index} onRecordingComplete={handleUserRecordingCompletion} existingAudioUrl={existingAudioUrl} /></div>
