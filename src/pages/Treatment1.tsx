...
const Treatment1 = () => {
  ...
  const getPhaseTitle = () => { if (currentProcessingStep === 0) return "Select Mismatch Experiences"; return `Phase ${currentProcessingStep}`; };
  ...
  return (
    <div className="p-6"> <div className="max-w-3xl mx-auto space-y-8">
        ...
        {showResultsView ? (
          <div className="text-center p-6 bg-card border rounded-xl"><h2>T{THIS_TREATMENT_NUMBER} Results!</h2><p>Final SUDS: {finalSudsResult}</p><Button onClick={() => navigate(`/calibrate/${THIS_TREATMENT_NUMBER + 1}`)}>Start T{THIS_TREATMENT_NUMBER + 1}</Button></div>
        ) : (
          <>
